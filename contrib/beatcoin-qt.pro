...
RESOURCES += src/qt/beatcoin.qrc src/qt/beatcoin_locale.qrc

TRANSLATIONS += src/qt/locale/beatcoin_bg.ts \
                src/qt/locale/beatcoin_de.ts \
                src/qt/locale/beatcoin_en.ts \
                src/qt/locale/beatcoin_es.ts \
                src/qt/locale/beatcoin_fi.ts \
                src/qt/locale/beatcoin_fr.ts \
                src/qt/locale/beatcoin_it.ts \
                src/qt/locale/beatcoin_ja.ts \
                src/qt/locale/beatcoin_pl.ts \
                src/qt/locale/beatcoin_pt.ts \
                src/qt/locale/beatcoin_ru.ts \
                src/qt/locale/beatcoin_sk.ts \
                src/qt/locale/beatcoin_sv.ts \
                src/qt/locale/beatcoin_vi.ts \
                src/qt/locale/beatcoin_zh_CN.ts \
                src/qt/locale/beatcoin_zh_TW.ts
