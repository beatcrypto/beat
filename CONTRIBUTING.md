Contributing to BeatCoin Core
============================

The BeatCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the BeatCoin Core project, and is not to be
confused with overall BeatCoin Network Protocol consensus changes.

Whether a pull request is merged into BeatCoin Core rests with the project merge
...
Patches that change BeatCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the BeatCoin consensus, it must have been
...
The project leader is the release manager for each BeatCoin Core release.
