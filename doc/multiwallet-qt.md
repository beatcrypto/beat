...
In order to support loading of multiple wallets in beatcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is beatcoin.cpp.
...
Changes to beatcoin.cpp
----------------------
beatcoin.cpp is the entry point into beatcoin-qt, and as such, will require some minor modifications to provide hooks for
