...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("BeatCoin Core"),
     ...
     * override -datadir in the beatcoin.conf file in the default data directory
     * (to be consistent with beatcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
