...
/** Utility functions used by the BeatCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render BeatCoin addresses in monospace font
...
// Parse "beatcoin:" URI into recipient object, return true on successful parsing
