                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("BeatCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BeatCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and beatcoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zBEAT"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BeatCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about BeatCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BeatCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BeatCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BeatCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a BeatCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BeatCoin Core help message to get a list with possible BeatCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BeatCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BeatCoin network", "", count));
}
...
{
    QString strTitle = tr("BeatCoin Core"); // default title
...
/** Creates context menu, its actions, and beatcoins up all the relevant signals for mouse events. */
