                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received BeatCoin from zBeatCoin"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zBeatCoin"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zBeatCoin));
