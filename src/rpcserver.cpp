...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BeatCoin features */
        {"beatcoin", "masternode", &masternode, true, true, false},
        {"beatcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"beatcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"beatcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"beatcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"beatcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"beatcoin", "startmasternode", &startmasternode, true, true, false},
        {"beatcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"beatcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"beatcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"beatcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"beatcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"beatcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"beatcoin", "mnbudget", &mnbudget, true, true, false},
        {"beatcoin", "preparebudget", &preparebudget, true, true, false},
        {"beatcoin", "submitbudget", &submitbudget, true, true, false},
        {"beatcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"beatcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"beatcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"beatcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"beatcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"beatcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"beatcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"beatcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"beatcoin", "mnsync", &mnsync, true, true, false},
        {"beatcoin", "spork", &spork, true, true, false},
        {"beatcoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"beatcoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use beatcoind, or the -server option to beatcoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> beatcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:16789/\n";
}
