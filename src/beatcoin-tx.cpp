...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("BeatCoin Core beatcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  beatcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded beatcoin transaction") + "\n" +
                               "  beatcoin-tx [options] -create [commands]   " + _("Create hex-encoded beatcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded beatcoin transaction
